            ...
            std::vector<int>& maxCoeffCell)
{
    ...
    if constexpr (has_bioeffects_) {
        ...
        const auto R1 = modelResid[cell_idx][contiBiofilmEqIdx];
        R_sum[contiBiofilmEqIdx] += R1;
        ...
        if constexpr (has_micp_) {
            ...
            const auto R2 = modelResid[cell_idx][contiMicrobialEqIdx];
            R_sum[contiMicrobialEqIdx] += R2;
