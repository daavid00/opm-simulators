...
class BlackOilParticleModule<TypeTag, true>
{
    ...
    static constexpr bool enableParticle = true;
...
template <class TypeTag>
BlackOilParticleParams<typename BlackOilParticleModule<TypeTag, true>::Scalar>
BlackOilParticleModule<TypeTag, true>::params_;
 ...
 */
template <class TypeTag>
class BlackOilParticleIntensiveQuantities<TypeTag, true>
{
    ...
    using ParticleModule = BlackOilParticleModule<TypeTag, true>;
...
template <class TypeTag>
class BlackOilParticleExtensiveQuantities<TypeTag, true>{};
