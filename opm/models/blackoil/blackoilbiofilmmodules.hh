...
public:
    ...
    const Evaluation& biofilmsConcentration() const
    { throw std::logic_error("biofilmsConcentration() called but BIOFILM is disabled!"); }

    const Evaluation& biofilmMass() const
    { throw std::logic_error("biofilmMass() called but BIOFILM is disabled!"); }

     const Evaluation& permPoro() const
    { throw std::logic_error("permPoro() called butBIOFILM is disabled"); }
};
