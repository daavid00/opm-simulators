...
struct BlackOilTwoPhaseIndices
{
    ...
    //! Index of the primary variable for the microbial component
    ...
    static constexpr int biofilmConcentrationIdx =
        enableBiofilm ? PVOffset + numPhases + numSolvents + numPolymers + 1 : -1000;
    ...
    //! Index of the continuity equation for the microbial component
