...
struct BlackOilTwoPhaseIndices
{
    ...
    static constexpr int numBiofilms = enableBiofilm ? numBioCompV : 0;
    ...
    static constexpr int numEq = numPhases + numSolvents + numExtbos + numPolymers +
                                 numEnergy + numFoam + numBrine + numBiofilms;
    ...
    static constexpr int biofilmConcentrationIdx =
        enableBiofilm ? PVOffset + numPhases + numSolvents + numPolymers : -1000;

    //! Index of the primary variable for the foam
    static constexpr int foamConcentrationIdx =
        enableFoam ? PVOffset + numPhases + numSolvents + numPolymers + numBiofilms : -1000;

    //! Index of the primary variable for the salt
    static constexpr int saltConcentrationIdx =
        enableBrine ? PVOffset + numPhases + numSolvents + numPolymers + numBiofilms + numFoam : -1000;

    //! Index of the primary variable for temperature
    static constexpr int temperatureIdx  =
        enableEnergy ? PVOffset + numPhases + numSolvents + numExtbos + numPolymers + numBiofilms + numFoam + numBrine : - 1000;
